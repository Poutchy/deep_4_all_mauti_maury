    ...
    def __getitem__(self, idx):
        ...
        if self.max_length is not None:
            padded_sequence = torch.full(
                (self.max_length,), self.pad_idx, dtype=torch.long
            )
...
def main(args):
    ...
    if gap > 0.10:
        ...
        print(
            "    -> Augmentez dropout, reduisez hidden_dim, ou ajoutez regularisation"
        )
...
if __name__ == "__main__":
    ...
    # Modèle
    parser.add_argument(
        "--embed_dim", type=int, default=258, help="Dimension des embeddings"
    )
    parser.add_argument(
        "--hidden_dim", type=int, default=258, help="Dimension de l'état caché RNN/LSTM"
    )
    parser.add_argument(
        "--num_layers", type=int, default=1, help="Nombre de couches RNN/LSTM"
    )
    parser.add_argument(
        "--dropout", type=float, default=0.0, help="Dropout entre les couches RNN"
    )
    parser.add_argument(
        "--mode",
        type=str,
    ...
    # Entraînement
    parser.add_argument("--epochs", type=int, default=6, help="Nombre d'epochs")
